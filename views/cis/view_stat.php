    ...
    <div class="row">
      <div class="col-md-12">
         ...
         <?php
		  ...
		  if ( $_GET ) $arFilter['export'] = '/cis/export/?'.http_build_query($_GET);
        ...
        <?php HTML::statAppFilter( $arFilter ); ?>
         ...
         <div class="box box-primary">
        	...
        	<div class="box-header with-border"><h3 class="box-title">Активность пользователей приложения "<?=$app->Cis->AppInfo()->ru_name?>"</h3></div>
