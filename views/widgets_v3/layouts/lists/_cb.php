...
<?php if ( $currentRoute->action == 'copy' ) $app->Widgets3->copyWidget( $currentRoute->id ); ?>
<?php $arRes = $app->Widgets3->getWidgetsByType( 1 ); ?>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <div class="box-header with-border"><h3 class="box-title"><?=$app->Widgets3->getTypeById(1)['ru_name']?></h3></div>
        
        <div class="box-body">
          <div class="col-xs-12">
            <a href="/widgets_v3/cb/new/" class="btn btn-info btn-flat"><i class="fa fa-plus" aria-hidden="true"></i> Добавить виджет</a>
          </div>
        </div>
        ...
        <div class="box-body">
          ...
          <table id="data-table-cb" class="table table-hover table-striped table-condensed dataTable">
            ...
            <tbody>
              ...
              <tr>
                <td><a href="/widgets_v3/cb/edit/<?=$item['id']?>/"><?=$item['id']?></a></td>
                <td><a href="/widgets_v3/cb/edit/<?=$item['id']?>/"><?=$item['ru_name']?></a></td>
