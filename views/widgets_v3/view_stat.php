...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><?=$app->Widgets3->AppInfo()->ru_name?> <small><?=HTML::getPageTitle( $currentRoute )?></small></h1>
  </section>
      ...
      <div class="col-md-12">
         ...
         <?php
          ...
          $arFilter = [
              ...
              'clear' => '/widgets_v3/stat/',
          ];
		  
		  if ( $_GET ) $arFilter['export'] = '/widgets_v3/export/?'.http_build_query($_GET);
        ...
        <?php HTML::statAppFilter( $arFilter ); ?>
         ...
         <div class="box box-primary">
        	...
        	<div class="box-header with-border"><h3 class="box-title">Активность пользователей приложения "<?=$app->Widgets3->AppInfo()->ru_name?>"</h3></div>
