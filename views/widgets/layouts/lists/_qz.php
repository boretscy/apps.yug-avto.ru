  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <div class="box-header with-border"><h3 class="box-title"><?=$app->Widgets->getTypeById(7)['ru_name'];?></h3></div>
        ...
        <div class="box-body">
          ...
          <table id="data-table-qz" class="table table-hover table-striped table-condensed dataTable">
            ...
            <tbody>
              ...
              <tr>
                <td><a href="/widgets/qz/edit/<?=$item['id']?>/"><?=$item['id']?></a></td>
                <td><a href="/widgets/qz/edit/<?=$item['id']?>/"><?=$item['ru_name']?></a></td>
