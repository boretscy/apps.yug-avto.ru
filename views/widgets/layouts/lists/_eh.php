...
<?php $arRes = $app->Widgets->getWidgetsByType( 10 ); ?>
...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="box box-primary">
            ...
            <div class="box-header with-border"><h3 class="box-title"><?=$app->Widgets->getTypeById(10)['ru_name']?></h3></div>
            
            <div class="box-body">
                <div class="col-xs-12">
                    <a href="/widgets/eh/new/" class="btn btn-info btn-flat"><i class="fa fa-plus" aria-hidden="true"></i> Добавить виджет</a>
                </div>
            </div>
            ...
            <table id="data-table-eh" class="table table-hover table-striped table-condensed dataTable">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><a href="/widgets/eh/edit/<?=$item['id']?>/"><?= $item['id'];?></a></td>
                        <td><a href="/widgets/eh/edit/<?=$item['id']?>/"><?= $item['ru_name'];?></a></td>
