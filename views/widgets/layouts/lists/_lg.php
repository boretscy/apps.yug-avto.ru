...
<?php if ( $currentRoute->action == 'copy' ) $POSTRes = $app->Widgets->copyWidget( $currentRoute->id ); ?>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <div class="box-header with-border"><h3 class="box-title"><?=$app->Widgets->getTypeById(2)['ru_name']?></h3></div>
          ...
          <table id="data-table-lg" class="table table-hover table-striped table-condensed dataTable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="overflow: hidden;"><?=implode(", ", $app->Widgets->getUrls($item['id']))?></td>
                ...
                <td style="text-align: right">
                  ...
                  <a href="/widgets/lg/copy/<?=$item['id']?>/">
