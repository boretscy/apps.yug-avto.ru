...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><?=$app->->AppInfo()->ru_name?> <small><?=HTML::getPageTitle( $currentRoute )?></small></h1>
  </section>
  
  <!-- Main content -->
  <section class="content">
    
    <?php if ( $app->->AppInfo()->maintenance ) include $_SERVER['DOCUMENT_ROOT'].'/upload/Apps/maintenance.php'; ?>
    ...
    <div class="row">
      <div class="col-md-12">
         ...
         <?php
		  ...
		  if ( $_GET ) $arFilter['export'] = '//export/?'.http_build_query($_GET);
        ...
        <?php HTML::statAppFilter( $arFilter ); ?>
         ...
         <div class="box box-primary">
        	...
        	<div class="box-header with-border"><h3 class="box-title">Активность пользователей приложения "<?=$app->->AppInfo()->ru_name?>"</h3></div>
