<?php $arRes = $app->Expertbot->getSources(); ?>

  <!-- Content Header (Page header) -->
  <section class="content-header">
    <h1><?=$app->Expertbot->AppInfo()->ru_name?> <small>Источники</small></h1>
  </section>
  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="col-xs-12">
            <a href="/expertbot/sources/new/" class="btn btn-info btn-flat"><i class="fa fa-plus" aria-hidden="true"></i> Добавить источник</a>
          </div>
        </div>
        ...
        <div class="box-body">
          ...
          <table class="table table-striped table-bordered table-sm" id="data-table-expertbot-sources">
            ...
            <tbody>
              ...
              <tr>
                <td><a href="/expertbot/sources/edit/<?=$item['id']?>/"><?= $item['id'];?></a></td>
                <td><a href="/expertbot/sources/edit/<?=$item['id']?>/"><?= $item['name'];?></a></td>
                <td class="text-right">
                  <a href="/expertbot/sources/edit/<?=$item['id']?>/">
