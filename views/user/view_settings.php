  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Управление пользователем <small>Настройки</small></h1>
    </section>
...
&lt;script src="https://apps.yug-avto.ru/API/get/script/?token=<?=$authUser->public_key?>" charset="utf-8"&gt;&lt;/script&gt;
              ...
              необходимо добавить на сайт <strong>перед закрывающим тегом &lt;/body&gt;</strong>
            </div><!-- /.box-body -->
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <? include __DIR__.'/layouts/_user_form.php'; ?>
            </div><!-- /.box-body -->
