...
<?php if ( $currentRoute->id ) $arRes = $app->HumanResourses->getStat( $currentRoute->id ); ?>
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <form role="form" method="post">
            ...
            <?php } ?>
            <input type="hidden" name="sent" value="<?=$arRes['sent']?>" />
                ...
                $formSet = [
                    'fields' => [
                        ...
                        [
                            'type' => 'date',
                            'name' => 'start_date',
                            'value' => date('d.m.Y H:i', (($arRes['start_timestamp'])?:time()+3600*24)),
                        ...
                        [
                            ...
                            'value' => $app->HumanResourses->getScheduleIDsByStat($arRes['id']),
