<?php if ( $currentRoute->id ) $arRes = $app->Parts->getSettingsById($currentRoute->id) ?>
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <form role="form" method="post">
            ...
            <input type="hidden" name="form" value="formPartsSettings" />
				...
				$formSet = [
					'fields' => [
						...
						[
							'type' => 'text',
							'name' => 'default_url',
							'placeholder' => 'Основная страница сервиса',
