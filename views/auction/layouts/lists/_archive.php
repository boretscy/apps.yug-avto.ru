<?php 
	...
	$statuses = ( $_GET['status_ids'] ) ?: [3,4,5];
...
<div class="box box-primary">
  ...
  <div class="box-header with-border"><h3 class="box-title">Архив</h3></div>
      ...
      <tbody>
        ...
        <tr class="<?=$app->Auction->getStatus($item['status_id'])['tr_color']?>">
          ...
          <td class="text-right">
            ...
            &nbsp;
            <a href="/auction/archive/delete/<?=$item['id']?>/" role="delete">
