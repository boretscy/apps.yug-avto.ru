<?php $arRes = $app->Calc->getColorSettins( $userSites['sites'] ); ?>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <table id="data-table-agents" class="table table-hover table-striped table-condensed dataTable">
            <thead>
              <tr>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="color-palette-set">
                    <div class="bg-green color-palette" style="background-color: <?=(($item['css']['gray'])?$item['css']['gray']:'#d3d3d3')?> !important;"><span><?=(($item['css']['gray'])?$item['css']['gray']:'#dedede')?></span></div>
                  </div>
                </td>
                ...
                <td class="text-right">
                  <a href="/calc/tuning/edit/<?=$item['id']?>/">
